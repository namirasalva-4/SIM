...
query1 = "SELECT o.orderNumber, country, sum(od.quantityordered * od.priceeach) as total_value
...
ggplot(data1, aes(x = total_value)) +
  ...
  labs(title = "Distribusi Nilai Pesanan di negara Nordic",
       subtitle = "Negara : Denmark, Finland, Norwaay, Sweden",
       x = "Nilai Pesanan (USD)",
       y = "Frekuensi") +
...
```{r} 
# membuat tabel data scara manual 
<tabel>
  <tr>
  <th
